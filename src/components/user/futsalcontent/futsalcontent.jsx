...
const futsalcontent = () => {
  ...
  const handleReserve = () => {
    const photoURL = { qr };
    const phoneContact = fetchData.data.futsal_contact;
    const dialogContent = `
    <div>
      <img src="${qr}" alt="QR Code" style="max-width: 50%;">
    </div>
    <p>Or pay through  Esewa or Khalti</p>
 <div className="form-group">
  ...
  border-radius: 4px;
  box-sizing: border-box;" id="phone" placeholder="${phoneContact}" disabled>
  </div>
  <div>
    <input type="text" style="
  padding: 12px 20px;
  ...
  border: 1px solid #ccc;
  border-radius: 4px;
  box-sizing: border-box;"  className="form-control" id="price" placeholder="Enter Price">
  </div>
</div>
    ...
    <>
      ...
      {fetchData.data ? (
        <div className="container py-4">
          ...
          <div className="row">
            <div className="rounded-3 card col-8">
              <div className="">
